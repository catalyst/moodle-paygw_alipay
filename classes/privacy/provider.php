...
/**
 * Privacy Subsystem implementation for paygw_alipay.
 *
...
namespace paygw_alipay\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $items) : collection {
        $items->add_database_table(
            'paygw_alipay',
            [
                'userid'       => 'privacy:metadata:paygw_alipay:userid',
                'status'       => 'privacy:metadata:paygw_alipay:status',
                'timecreated'  => 'privacy:metadata:paygw_alipay:timecreated',
                'timemodified' => 'privacy:metadata:paygw_alipay:timemodified',
            ],
            'privacy:metadata:paygw_alipay'
        );
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment) {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_alipay');
        $record = $DB->get_record('paygw_alipay', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams) {
        ...
        $DB->delete_records_select('paygw_alipay', "paymentid IN ({$paymentsql})", $paymentparams);
    }
