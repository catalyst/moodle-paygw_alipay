...
$payment = \paygw_alipay\alipay_helper::get_payment_script($config, $neworder, 'TEST', "40");
if ($payment) {
    echo "Trying to redirect - please wait";
    echo $payment;
} else {
    echo "payment attempt failed";
}
